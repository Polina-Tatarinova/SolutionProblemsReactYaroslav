    ...
    <div className="container">
      <header className="header-nav">
        <div className="header-title-section">
          ...
          <p>Полное интерактивное руководство: от JSX и хуков до классовых компонентов и собственных решений</p>
        </div>
          ...
          <div className="card-header">
            ...
            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
              ...
              {activeTab !== 7 && (
                ...
                >
                  {showSolution ? '🙈 Скрыть решение' : '💡 Показать эталонное решение'}
                </button>
              )}
            </div>
          </div>

    ...
    <div className="grid-2">
      ...
      <div className="demo-area">
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1rem' }}>
          <input
            ...
            style={{ flex: 1 }}
          />
          <button className="btn" onClick={handleFocus}>Сфокусировать</button>
        </div>
      </div>
      ...
      <div className="demo-area">
        ...
        <div style={{ padding: '0.8rem', background: 'var(--bg-secondary)', borderRadius: '6px' }}>
          Количество ререндеров компонента: <strong style={{ color: 'var(--accent-purple)' }}>{renderCountRef.current}</strong>
        </div>
      </div>
    </div>
  );

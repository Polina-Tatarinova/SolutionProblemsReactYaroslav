  ...
  return (
    <div className="task-container">
      <div className="instruction-box">
        ...
        <ul>
          <li>
            Объедините знания <code>useState</code>, <code>useRef</code>,{" "}
            <code>map/key</code> и <code>custom hooks</code>.
          </li>
          <li>
            Реализовано добавление, удаление, фильтрация и автосохранение задач
            в localStorage.
          </li>
        </ul>
      </div>
      ...
      <div className="demo-area">
        ...
        >
          <div style={{ display: "flex", gap: "0.4rem" }}>
            ...
            >
              Завершенные ({todos.length - activeCount})
            </button>
          </div>
        ...
        >
          {filteredTodos.length === 0 ? (
            ...
            >
              Задачи отсутствуют в этой категории.
            </p>
          ) : (

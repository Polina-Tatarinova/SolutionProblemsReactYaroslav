  ...
  return (
    <div className="task-container">
      <div className="instruction-box">
        ...
        <ul>
          <li>Получите ссылку на инпут элемент DOM и фокусируйтесь на нем по нажатию кнопки.</li>
          <li>Используйте <code>useRef</code> для хранения переменной, изменение которой не вызывает ререндер компонента.</li>
        </ul>
      </div>
      ...
      <div className="grid-2">
        ...
        <div className="demo-area">
          <h3 style={{ marginBottom: '1rem' }}>1. Управление фокусом DOM-элемента</h3>
        ...
        <div className="demo-area">
          <h3 style={{ marginBottom: '1rem' }}>2. Хранение мутабельного значения</h3>
          ...
          <div style={{ padding: '0.8rem', background: 'var(--bg-secondary)', borderRadius: '6px' }}>
            Количество ререндеров компонента: <strong style={{ color: 'var(--accent-purple)' }}>0</strong>
          </div>
        </div>
      </div>
    </div>
